...
public class Yolov5TFLiteDetector {
    ...
    private int[] OUTPUT_SIZE = new int[]{1, 6300, 85};
    ...
    private String MODEL_FILE="yolov5s-fp16.tflite";
    ...
    //获得模型参数的函数。
    public void setYOLO(int output_a,int output_b,int output_c,int input_width,int input_height,String labelname){
        OUTPUT_SIZE=new int[]{output_a,output_b,output_c};
        INPNUT_SIZE=new Size(input_width,input_height);
